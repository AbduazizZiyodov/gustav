...
- add support for identity (IS) operator (experimental)
- add value types, error handling, comparision/equality ... operators support
- finish compiler (prefix, infix ops) -- over-engineered arithmetic calculator
- scanner
- OP_NEGATE in-place without stack manipulation (pop/push)
- vm implementation, core lifecycle
